Feature: TechGlobal Project 4 Submission

  @Project4
  Scenario: Validate Default content
    ...
    And the user should see the “Total = $"total"” text displayed

    Scenario: Validate add product modal
      Given user navigates to "https://techglobal-training.com/frontend/project-4"
      ...
      Scenario: Validate add new product button with x modal
      Given user navigates to "https://techglobal-training.com/frontend/project-4"
      When the user clicks on the “ADD PRODUCT” button
      Then the user should see the “Add New Product” modal with its heading
      ...
      Then the user should not see the “Add New Product” modal
        ...
        Scenario: validate new product added
        Given user navigates to "https://techglobal-training.com/frontend/project-4"
        When the user clicks on the “ADD PRODUCT” button
